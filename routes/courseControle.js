...
router.get("/trainerCourses", authenticateToken, async (req, res) => {
  try {
...
//     res
//       .status(500)
//       .json({ error: "An error occurred while retrieving quizzes" });
//   }
// });
...
router.post("/Evaluate", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    var rating =
      (sommeRating + req.body.Data.rate) / (course.evaluate.length + 1);
